...
analyze -format verilog $SRC/regist_15bit.v
elaborate regist_15bit

analyze -format verilog $SRC/regist_16bit.v
elaborate regist_16bit
...
check_design > $REPORT/check_design_M163_D16.rpt
check_timing > $REPORT/check_timing_M163_D16.rpt
...
report_design > $REPORT/M163_D16.rpt
report_area -h >> $REPORT/M163_D16.rpt
report_power >> $REPORT/M163_D16.rpt
report_timing -delay max -max_paths 200 > $REPORT/timing_setup_M163_D16.rpt
report_timing -delay min -max_paths 200 > $REPORT/timing_hold_M163_D16.rpt
report_constraint -all_violators -verbose > $REPORT/con_violators_M163_D16.rpt


write -format verilog -output $EXPORT/M163_D16.v -hierarchy
write -format ddc -output $EXPORT/M163_D16.ddc -hierarchy
write_sdf $EXPORT/M163_D16.sdf
write_sdc $EXPORT/M163_D16.sdc