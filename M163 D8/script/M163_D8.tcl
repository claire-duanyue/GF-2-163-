...
analyze -format verilog $SRC/regist_7bit.v
elaborate regist_7bit

analyze -format verilog $SRC/regist_8bit.v
elaborate regist_8bit
...
create_clock -period 3.5 -name clk [get_ports clk]
...
check_design > $REPORT/check_design_M163_D8.rpt
check_timing > $REPORT/check_timing_M163_D8.rpt
...
report_design > $REPORT/M163_D8.rpt
report_area -h >> $REPORT/M163_D8.rpt
report_power >> $REPORT/M163_D8.rpt
report_timing -delay max -max_paths 200 > $REPORT/timing_setup_M163_D8.rpt
report_timing -delay min -max_paths 200 > $REPORT/timing_hold_M163_D8.rpt
report_constraint -all_violators -verbose > $REPORT/con_violators_M163_D8.rpt


write -format verilog -output $EXPORT/M163_D8.v -hierarchy
write -format ddc -output $EXPORT/M163_D8.ddc -hierarchy
write_sdf $EXPORT/M163_D8.sdf
write_sdc $EXPORT/M163_D8.sdc